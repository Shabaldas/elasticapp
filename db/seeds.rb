25.times do
  Item.create sku: Faker::Alphanumeric.alphanumeric(number: 10, min_alpha: 3, min_numeric: 3),
              ...
              fulfilment_free: Faker::Commerce.price(range: 0..2.99),
...
5000.times do
  ...
  fulfilment_center = %w[5bs yg1 mej xqf 4wj].sample

  PurchaseOrder.create  order_num: "#{Faker::Number.number(digits: 3)}-#{Faker::Number.number(digits: 8)}",
                        purchase_date: purchase_date,
                        status: order_type,
                        sales_channel: ['amazon.com', 'ebay.com', 'walmart.com', 'rozetka.com'].sample,
                        ...
                        fulfillment_center: fulfilment_center,
