...
class PurchaseOrdersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create purchase_order" do
    assert_difference('PurchaseOrder.count') do
      post purchase_orders_url, params: { purchase_order: { carrier: @purchase_order.carrier, confirmed_at: @purchase_order.confirmed_at, estimated_arrival_date: @purchase_order.estimated_arrival_date, fulfillment_center: @purchase_order.fulfillment_center, notes: @purchase_order.notes, num_items_shipped: @purchase_order.num_items_shipped, num_items_unshipped: @purchase_order.num_items_unshipped, order_num: @purchase_order.order_num, order_total: @purchase_order.order_total, payment_method: @purchase_order.payment_method, purhase_date: @purchase_order.purhase_date, refunded_at: @purchase_order.refunded_at, return_reason: @purchase_order.return_reason, returned_date: @purchase_order.returned_date, sales_channel: @purchase_order.sales_channel, ship_to_address: @purchase_order.ship_to_address, ship_to_name: @purchase_order.ship_to_name, shipped_at: @purchase_order.shipped_at, shipping_price: @purchase_order.shipping_price, shipping_tax: @purchase_order.shipping_tax, status: @purchase_order.status, tracking_number: @purchase_order.tracking_number } }
    end
